        ...
        <div className="w-full max-w-2xl mx-auto p-4 pb-20">
            ...
            <div className="mb-8">
                <div className="flex justify-between items-center mb-3 ml-1">
                    ...
                    {/* NOUVEAU : Message d'avertissement si tout est décoché */}
            ...
            {/* Boutons Postures (Désactivés si pas de plateforme) */}
            <div className="grid grid-cols-1 gap-4 mb-10">
                <button
                    onClick={() => handleGenerate('incarné')}
                    disabled={loading || !image || !isAnyPlatformSelected} // Sécurité ajoutée ici
            ...
            {loading && (
                <div className="text-center py-8 animate-pulse">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 font-medium">L'IA rédige pour vos réseaux...</p>
                </div>
            )}
            ...
            {results && typeof results === 'object' && (
                <div className="space-y-8 animate-fade-in-up">
                    ...
                    <div className="mt-12 text-center">
                        <button onClick={() => { setResults(null); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-gray-500 hover:text-blue-600 font-medium flex items-center justify-center mx-auto space-x-2">
